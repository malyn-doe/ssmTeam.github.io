...
let namesList = ["Alanna","Ameer","Amira","Brydan","Chay","Christoffer","Emily", "Frankie","Jason","Kersti","Kristy","Leila","Luchia","Malyn","Maria", "Olena","Paul B", "Paul K","Ricardo", "Toni"];
let currentWinner;
let pickedNames = [];
...
function pickOne() {
      ...
      if (max > 0){
        ...
        if (currentWinner == 'Kersti' || currentWinner =='Kristy'){
